            ...
            <div class="col-md-10">
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                                    ...
                                    <div class="card mb-3">
                                        <div class="card-body text-center p-0">
                                            <a href="{{ route('videos.show', $value->video->id) }}" style="position: relative">
                                                ...
                                                <a class="btn btn-outline-secondary btn-sm" style="position: absolute; right: 0%" data-toggle="modal"
                        ...
                        <div>
                            <span>
                                <a class="btn btn-outline-primary" href="{{ route('group.video.add', $groupId) }}">Add video</a>
                            </span>
